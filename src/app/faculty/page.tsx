...
const facultyMembers = [
    {
        name: "Kalakshethra Anjali",
        role: "Classical Dance Expert",
        bio: "A dedicated artist trained in the classical Kalakshethra style, Anjali Ma’am brings grace, discipline, and traditional depth to every session. With years of stage experience and a strong teaching background, she helps students master technique, expression, and confidence in classical dance.",
        specialty: "Bharatanatyam Master",
        years: "15+ Years"
    },
    {
        name: "Kalakshetra Namitha",
        role: "Classical & Semi-Classical",
        bio: "Known for her warm teaching style and exceptional command over classical and semi-classical forms, Namitha Ma’am blends creativity with strong foundational training. She focuses on building rhythm, posture, and expression, making learning enjoyable and inspiring for all levels of students.",
        specialty: "Rhythmic Choreography",
        years: "12+ Years"
    },
    {
        name: "Kalamandalam Paravathy",
        role: "Rhythm & Expression",
        bio: "Known for her warm teaching style and exceptional command over classical and semi-classical forms, Parvathi Ma’am blends creativity with strong foundational training. She focuses on building rhythm, posture, and expression, making learning enjoyable and inspiring for all levels of students.",
        specialty: "Mohiniyattam Expert",
        years: "18+ Years"
    },
    {
        name: "Kalamandalam Namitha",
        role: "Traditional Methodology",
        bio: "Trained from the prestigious Kerala Kalamandalam, Namitha Ma’am embodies authenticity, precision, and a deep-rooted understanding of Indian classical dance traditions. Her teaching approach blends traditional techniques with modern methodology.",
        specialty: "Abhinaya Specialist",
        years: "10+ Years"
    },
    {
        name: "Kalakshetra Arya",
        role: "Contemporary & Classical",
        bio: "Arya Ma’am is a passionate performer and mentor who specializes in classical and contemporary dance. Her energetic approach, commitment to detail, and ability to connect with students make her classes both dynamic and transformative.",
        specialty: "Fusion & Modern",
        years: "8+ Years"
    }
];
